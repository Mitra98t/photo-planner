  ...
  return (
    <ul className="w-full h-full flex justify-center flex-wrap gap-2 px-4 ">
      {personalProfile ? (
        <li
          key={"addImage"}
          className="flex-grow h-[35vh] min-w-[30vW] max-w-full group bg-stone-100 dark:bg-dark-800 border-4 border-dashed border-stone-500 dark:border-dark-600 flex items-center justify-center rounded-2xl hover:bg-stone-300 dark:hover:border-dark-400 duration-100"
          role={"button"}
