  ...
  return (
    <div className="w-full h-full bg-stone-50 rounded-t-3xl gap-8 flex flex-row items-center justify-between px-12">
      ...
      <div className=" h-3/5 flex-1 flex items-center justify-end  gap-12">
        <a href="https://padlet.com/personalmailfm98/feed-back-y89afrpn4r234gut" className="font-semibold text-lg text-stone-900 hover:scale-110 transition-all ease-in-out duration-150" >Feedback and Ideas</a>
